...
public class MortarMonkeyUpgrades : UpgradeDetailedDescriptions
{
    public override Dictionary<string, string> Table => new()
    {
        ...
        { UpgradeType.TheBigOne, "+40p (85), +1cd, <i>Normal</i>. <u>Explosion</u> buffed: +4d (7)." },
        {
            UpgradeType.TheBiggestOne,
            "+115p (200). <u>Explosion</u> buffed: +20d (25), +20cd (40), +20md (40), ~80 blast radius. <u>Shockwave</u> buffed: +20cd (11) outside stun, ~120 blast radius. Stuns MOABs: MOAB 0.3s, BFB/DDT 0.2s, ZOMG 0.1s"
        },
        ...
        { UpgradeType.HeavyShells, "+3cd (4), +1md (2), +1fd, +1 lead damage, +2 stunned damage, <i>Normal</i>." },
        {
            ...
            "25%s (0.27). +4d to BADs,Bosses. Ability (60s cooldown): 4x attack rate and +15% blast radius for 8s."
        },
        {
            UpgradeType.PopAndAwe,
            "+8 stunned damage (+10), +9cd (12), +3ld (4), +3fd (4), +3md (4). +10d to BADs,Bosses for itself and all x4x Mortars. Ability (60s cooldown): Every second for the next 8 seconds, hits everything on screen for 20d and a 1s stun."
        },

        { UpgradeType.IncreasedAccuracy, "Less variance in shell target." },
        {
            UpgradeType.BurnyStuff,
            "On-damage effect: apply <u>Burn</u> status (1d/1.25s (2d, 5d, 45d for 302,402,502), <i>Fire</i>, 3.75s duration)."
        },
        { UpgradeType.SignalFlare, "Camo. Creates AoE De-camo (50r, 80p)" },
        { UpgradeType.ShatteringShells, "<u>Burn</u> status buffed: 5d/.75s. On-hit effect: De-regrow, De-fortify, De-camo, but still not DDTs. " },
        {
            UpgradeType.Blooncineration,
            "<i>Normal</i>, 100md/1s. De-camo and De-fortify now affect DDTs. " +
